...
{
    [TestCaseOrderer("Features.Test.PriorityOrderer","Features.Tests")]
    ...
    public class UsuarioTests
    {
        ...
        [Fact(DisplayName = "Tentativa de cadastro com senha fraca"), TestPriority(3)]
        [Trait("Usuário", "Integração Web - Usuário")]
        ...
        [Trait("Usuário", "Integração Web - Usuário")]
        public async Task Usuario_RealizarLogin_DeveExcecutarComSucesso()
        {
            ...
            //assert
            postResponse.EnsureSuccessStatusCode();
            //Assert.Contains($"Hello {"teste@teste.com"}!", responseString);
        }
    }
}
